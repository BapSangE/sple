...
- `IG_PAGE_ACCESS_TOKEN`은 Sple Instagram 비즈니스 계정으로 발급한 장기 액세스 토큰이며, DM 답장에만 사용합니다.
- `INSTAGRAM_BUSINESS_ACCOUNT_ID`는 `sple_place`의 Instagram 비즈니스 계정 ID입니다.
...
migrations/20260916170000_instagram_shares.sql
```
